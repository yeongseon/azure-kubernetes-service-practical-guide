...
| Extensions | [AGC Traffic Not Flowing](extensions/agc-traffic-not-flowing.md), [Istio Sidecar Injection Failure](extensions/istio-sidecar-injection-failure.md), [Flux Reconciliation Stuck](extensions/flux-reconciliation-stuck.md), [Dapr Sidecar Fails to Start](extensions/dapr-sidecar-fails-to-start.md) |
| Identity | [OIDC Issuer Mismatch](identity/oidc-issuer-mismatch.md), [Audience Mismatch](identity/audience-mismatch.md), [RBAC Succeeds but Key Vault Fails](identity/rbac-success-key-vault-fail.md), [Token Exchange Failure](identity/token-exchange-failure.md) |
...
| Scheduling / Placement | [Scheduling / Placement](scheduling/index.md), [Topology Spread Skew Under Capacity](scheduling/topology-spread-skew-under-capacity.md), [Ready Capacity Drops Below Desired](scheduling/ready-capacity-drops-below-desired.md), [Pod Disruption Budget Drain Contract](scheduling/pdb-drain-disruption-contract.md), [Availability-Zone-Imbalanced Node Pools and Spread Failures](scheduling/az-imbalanced-node-pools-spread.md) |
