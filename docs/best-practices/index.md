...
Create a single opinionated standard so cluster teams are not renegotiating node pools, network boundaries, ingress, security, and observability on every deployment.
