...
Teach teams what bad platform patterns look like before those patterns become expensive incident narratives.
...
**Focus for recognizing and replacing recurring failure patterns**: This practice should be interpreted through the lens of recognizing and replacing recurring failure patterns. Reviewers should ask whether the chosen implementation strengthens or weakens that focus area.
...
- [Azure / Aks / Operator Best Practices Cluster Isolation](https://learn.microsoft.com/azure/aks/operator-best-practices-cluster-isolation)
