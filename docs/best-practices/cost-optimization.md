...
Reduce waste without reducing resilience by tuning pool mix, autoscaling, and monitoring scope to actual workload behavior.
...
**Focus for right-sizing, spot pools, and observability spend**: This practice should be interpreted through the lens of right-sizing, spot pools, and observability spend. Reviewers should ask whether the chosen implementation strengthens or weakens that focus area.
