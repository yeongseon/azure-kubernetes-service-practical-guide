...
Define the minimum viable production platform so environments are repeatable, auditable, and safe to upgrade.
...
**Focus for baseline controls and platform defaults**: This practice should be interpreted through the lens of baseline controls and platform defaults. Reviewers should ask whether the chosen implementation strengthens or weakens that focus area.
