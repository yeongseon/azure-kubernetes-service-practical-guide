...
**Focus for availability, probes, upgrades, and disaster recovery**: This practice should be interpreted through the lens of availability, probes, upgrades, and disaster recovery. Reviewers should ask whether the chosen implementation strengthens or weakens that focus area.
...
- [Best Practices: Platform Extensions](platform-extensions.md)
